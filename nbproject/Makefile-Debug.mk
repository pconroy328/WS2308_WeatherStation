...
LDLIBSOPTIONS=-L\"${`mysql_config\ --libs`}\" -lm /usr/local/lib/libinifiler.a -lmysqlclient /usr/local/lib/libmovingaverage_lib.a /usr/lib/x86_64-linux-gnu/libmosquitto.so
